...
import 'screens/customer/weekly_invoice_screen.dart';
...
String? _buildPayload(Map<String, dynamic> data) {
  ...
  final invoiceId = data['weeklyInvoiceId'] as String?;
  if (screen == 'weekly_invoice' && invoiceId != null) return 'weekly_invoice:$invoiceId';
...
class _HomieAppState extends State<HomieApp> {
  ...
  Future<void> _initFCM() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      } else if (type == 'weekly_invoice') {
        channelId = 'invoices_channel'; channelName = 'Faktúry';
      }
